...
var config = {
  sql: {
    ...
    batchSize: process.env.DB_BATCH_SIZE || 500
  },
  storage: {
  ...
  queue: {
    visibilityTimeoutSecs: process.env.QUEUE_VISIBILITY_TIMEOUT_SECS || 300,
    checkFrequencyMsecs: process.env.QUEUE_CHECK_FREQUENCY_MSECS || 5000
  },
  blobs: {
  ...
  services: {
    docServiceUrl: process.env.SERVICE_DOC_URL,
      scoring: [
        { id: 'SK', url: process.env.SK_SCORING_URL }, 
        { id: 'TLC', url: process.env.TLC_SCORING_URL }
      ]
  }
};
