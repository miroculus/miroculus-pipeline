...
var skServiceUrl = config.services.skScoringServiceUrl + '/score';
    ...
    function (err) {
      ...
      */
      ...
      function getScoring2(data, cb) {
       ...
       /*
       // CHECK WITH NADAV
       // currently removing duplicates entities so that 
       // i don't get mulitple relations with the same entities
       // which cause inserting to the DB to fail on duplicate key
       // TODO: transfer as is to nadav.
       // move duplicate filtering to the response
        var cache = {};
        var mentions = data.mentions.filter(function (mention) {
          var key = mention.type + '-' + mention.id;
          if (!cache[key]) {
            cache[key] = 1;
            return mention;
          }
        ...
        return request(opts, function (err, resp, body) {
          ...
          relations.forEach(function (relation) {
            ...
            entities.forEach(function (entity) {
              if (!results.entities.find(function (obj) {
