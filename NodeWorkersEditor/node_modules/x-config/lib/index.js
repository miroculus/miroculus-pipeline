...
var config = {
    ...
    log: {
        ...
        transporters: [
            { name: 'console', write : true, default: false },
            {
    ...
    services: {
      ...
      skScoringServiceUrl: process.env.SK_SCORING_URL
    }
};
...
checkParam(config.services.skScoringServiceUrl, 'sk scoring service url', 'SK_SCORING_URL');
