...
function run(callback) {
    ...
    log.init({
        ...
        function processMessage(message, cb) {
            ...
            console.info("Processing document id %s from %s...", docId, source);
            ...
            return db.upsertDocument(docId, '', messageData.sourceId, function (err, result) {
                ...
                console.info('Searching for sentences...');
                return service.getDocumentSentences(docId, source, function (err, sentencesArray) {
                    ...
                    */
                    function processSentence(sentence, cb) {
                        ...
                        var outMessage = parserUtils.createQueueSentenceMessage({ sourceId: messageData.sourceId, docId: docId, index: index, sentenceData: sentence });
                        
                        return queueOut.sendMessage(outMessage, function (err) {
                            
                            if (err) {
                                console.error('failed to queue message: <%s> of paper <%s>', sentense, docId);
                                return cb(err);
                            }
