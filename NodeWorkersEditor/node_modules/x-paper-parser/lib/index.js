...
function run(callback) {
    ...
    log.init({
        ...
        function checkQueue () {
            console.info("Quering for next message in queue");
        ...
        function processMessage(message, cb) {
            ...
            return db.upsertDocument(docId, '', messageData.sourceId, function (err, result) {
                ...
                return service.getDocumentContent(docId, source, function (err, paperContent) {
                    ...
                    console.info('Found {} sentences', sentences && sentences.length || 0);
                    ...
                    return async.each(sentences, processSentence, function (err) {
                        ...
                        console.info('done enqueuing messages for document <{}>', docId);
                    ...
                    var outMessage = parserUtils.createQueueSentenceMessage(messageData.sourceId, docId, index, sentence);

                        return queueOut.sendMessage(outMessage, function (err) {

                            if (err) {
                                console.error('failed to enqueu message: <{}> of paper <{}>', sentense, docId);
                                return cb(err);
                            }
